          ...
          <form class="form" action="submit" @submit.prevent="makeDeposit">
            <div class="form-group">
              <div class="row">
                ...
                <input type="number" id="bills" step="1" min="0" v-model.number="deposit.bills" @keyup="calculateTotal" required>
              </div>
              <div class="row">
                <label for="coins">Coins:</label>
                <input type="number" id="coins" step=".01" min="0" v-model.number="deposit.coins" @keyup="calculateTotal" required>
              </div>
              <div class="row">
                <label for="checks">Checks:</label>
                <input type="number" id="checks" step=".01" min="0" v-model.number="deposit.checks" @keyup="calculateTotal" required>
              </div>
            </div>
